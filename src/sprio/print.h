...
#define job_format_add_age_time_priority_normalized(list,wid,right,suffix) \
	job_format_add_function(list,wid,right,suffix,_print_age_time_priority_normalized)
#define job_format_add_age_time_priority_weighted(list,wid,right,suffix) \
	job_format_add_function(list,wid,right,suffix,_print_age_time_priority_weighted)
...
int _print_age_priority_weighted(priority_factors_object_t * job, int width,
				 bool right_justify, char* suffix);
int _print_age_time_priority_normalized(priority_factors_object_t * job,
					int width, bool right_justify,
					char* suffix);
int _print_age_time_priority_weighted(priority_factors_object_t * job,
				      int width, bool right_justify,
				      char* suffix);
